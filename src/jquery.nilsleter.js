...
;(function ( $, window, document, undefined ) {
        ...
        Plugin.prototype = {
                init: function () {
                    ...
                    form_name += '      <input type="text" class="form-control" id="nl-input-nome" placeholder="'+label.nome+'">';
                    form_name += '    </div>';
                    form_name += ' </div>';
                    ...
                    form_email += '      <input type="email" class="form-control" id="nl-input-email" placeholder="'+label.email+'">';
                    form_email += '    </div>';
                    form_email += ' </div>';
                    ...
                    form_submit += '    <span class="loading-item">Loading...</span>';
                    form_submit += '  </div>';
